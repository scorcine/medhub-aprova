/**
 * Junta scripts/_parts/cli-*.json (whitelist v2) → data/questions-clinica.json
...
const SEED_STR = "20260721cliv2";

/** Parts reescritas no padrão R1 (não misturar cli-* antigo sem sufixo v2). */
const WHITELIST = [
  "cli-cm-cardio1.json",
  "cli-cm-cardio2.json",
  "cli-cm-pneumo1.json",
  "cli-cm-infecto1.json",
  "cli-cm-infecto2.json",
  "cli-cm-neuro1.json",
  "cli-cm-endo1.json",
  "cli-cm-nefro1.json",
  "cli-cm-hemato1.json",
...
function itemOk (q) {
  ...
  if (!looksLikeCliVignette(q.stem)) return false;
...
function main () {
  ...
  if (!files.length) throw new Error("Nenhum cli-* da whitelist v2 encontrado em scripts/_parts");
